  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="connectGatewayApp.analyticCollectionServiceConnectEvent.home.createOrEditLabel">
            <Translate contentKey="connectGatewayApp.analyticCollectionServiceConnectEvent.home.createOrEditLabel">
