  ...
  return (
    <div>
      <h2 id="connect-state-heading">
        <Translate contentKey="connectGatewayApp.analyticCollectionServiceConnectState.home.title">Connect States</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="connectGatewayApp.analyticCollectionServiceConnectState.home.createLabel">
            Create new Connect State
          </Translate>
        </Link>
      </h2>
        ...
        {connectStateList && connectStateList.length > 0 ? (
            ...
            <tbody>
              {connectStateList.map((connectState, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{connectState.channel}</td>
                  <td>{connectState.intentId}</td>
                  <td>{connectState.intentType}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="connectGatewayApp.analyticCollectionServiceConnectState.home.notFound">
                No Connect States found
              </Translate>
            </div>
          )
        )}
