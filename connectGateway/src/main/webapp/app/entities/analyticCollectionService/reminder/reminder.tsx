  ...
  return (
    <div>
      <h2 id="reminder-heading">
        <Translate contentKey="connectGatewayApp.analyticCollectionServiceReminder.home.title">Reminders</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="connectGatewayApp.analyticCollectionServiceReminder.home.createLabel">Create new Reminder</Translate>
        </Link>
      </h2>
        ...
        {reminderList && reminderList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="connectGatewayApp.analyticCollectionServiceReminder.home.notFound">No Reminders found</Translate>
            </div>
          )
        )}
      </div>
