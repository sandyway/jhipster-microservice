  ...
  return (
    <div>
      <h2 id="recipient-heading">
        <Translate contentKey="connectGatewayApp.analyticCollectionServiceRecipient.home.title">Recipients</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="connectGatewayApp.analyticCollectionServiceRecipient.home.createLabel">Create new Recipient</Translate>
        </Link>
      </h2>
        ...
        {recipientList && recipientList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="connectGatewayApp.analyticCollectionServiceRecipient.home.notFound">No Recipients found</Translate>
            </div>
          )
        )}
      </div>
