  ...
  return (
    <div>
      <h2 id="connect-intent-heading">
        <Translate contentKey="connectGatewayApp.analyticCollectionServiceConnectIntent.home.title">Connect Intents</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="connectGatewayApp.analyticCollectionServiceConnectIntent.home.createLabel">
            Create new Connect Intent
          </Translate>
        </Link>
      </h2>
        ...
        {connectIntentList && connectIntentList.length > 0 ? (
            ...
            <tbody>
              {connectIntentList.map((connectIntent, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{connectIntent.connectChannel}</td>
                  <td>{connectIntent.description}</td>
                  <td>{connectIntent.connectType}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="connectGatewayApp.analyticCollectionServiceConnectIntent.home.notFound">
                No Connect Intents found
              </Translate>
            </div>
          )
        )}
