...
export const ConnectIntentDetail = (props: IConnectIntentDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="connectGatewayApp.analyticCollectionServiceConnectIntent.detail.title">ConnectIntent</Translate> [
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="connectChannel">
              <Translate contentKey="connectGatewayApp.analyticCollectionServiceConnectIntent.connectChannel">Connect Channel</Translate>
            </span>
          </dt>
