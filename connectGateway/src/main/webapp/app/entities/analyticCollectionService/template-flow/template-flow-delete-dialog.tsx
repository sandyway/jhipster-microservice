...
export const TemplateFlowDeleteDialog = (props: ITemplateFlowDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="connectGatewayApp.analyticCollectionServiceTemplateFlow.delete.question">
        <Translate
          contentKey="connectGatewayApp.analyticCollectionServiceTemplateFlow.delete.question"
          interpolate={{ id: templateFlowEntity.id }}
        >
