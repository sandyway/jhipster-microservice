...
export const CampaignFlowDeleteDialog = (props: ICampaignFlowDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="connectGatewayApp.connectServiceCampaignFlow.delete.question">
        <Translate contentKey="connectGatewayApp.connectServiceCampaignFlow.delete.question" interpolate={{ id: campaignFlowEntity.id }}>
