  ...
  return (
    <div>
      <h2 id="connect-event-heading">
        <Translate contentKey="connectGatewayApp.connectServiceConnectEvent.home.title">Connect Events</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="connectGatewayApp.connectServiceConnectEvent.home.createLabel">Create new Connect Event</Translate>
        </Link>
      </h2>
        ...
        {connectEventList && connectEventList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="connectGatewayApp.connectServiceConnectEvent.home.notFound">No Connect Events found</Translate>
            </div>
          )
        )}
      </div>
