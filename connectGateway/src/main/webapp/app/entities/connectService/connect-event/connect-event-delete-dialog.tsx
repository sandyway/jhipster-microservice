...
export const ConnectEventDeleteDialog = (props: IConnectEventDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="connectGatewayApp.connectServiceConnectEvent.delete.question">
        <Translate contentKey="connectGatewayApp.connectServiceConnectEvent.delete.question" interpolate={{ id: connectEventEntity.id }}>
