...
export const ConnectStateDeleteDialog = (props: IConnectStateDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="connectGatewayApp.connectServiceConnectState.delete.question">
        <Translate contentKey="connectGatewayApp.connectServiceConnectState.delete.question" interpolate={{ id: connectStateEntity.id }}>
