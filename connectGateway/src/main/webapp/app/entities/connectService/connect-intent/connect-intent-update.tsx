  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="connectGatewayApp.connectServiceConnectIntent.home.createOrEditLabel">
            <Translate contentKey="connectGatewayApp.connectServiceConnectIntent.home.createOrEditLabel">
            ...
            <AvForm model={isNew ? {} : connectIntentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput
                  ...
                  name="connectChannel"
                  value={(!isNew && connectIntentEntity.connectChannel) || 'SMS'}
                >
              ...
              <AvGroup>
                ...
                <AvInput
                  ...
                  className="form-control"
                  name="connectType"
                  value={(!isNew && connectIntentEntity.connectType) || 'ADHOC'}
                >
