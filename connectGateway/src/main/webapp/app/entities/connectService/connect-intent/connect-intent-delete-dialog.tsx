...
export const ConnectIntentDeleteDialog = (props: IConnectIntentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="connectGatewayApp.connectServiceConnectIntent.delete.question">
        <Translate contentKey="connectGatewayApp.connectServiceConnectIntent.delete.question" interpolate={{ id: connectIntentEntity.id }}>
