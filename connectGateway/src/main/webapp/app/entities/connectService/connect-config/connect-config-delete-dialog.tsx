...
export const ConnectConfigDeleteDialog = (props: IConnectConfigDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="connectGatewayApp.connectServiceConnectConfig.delete.question">
        <Translate contentKey="connectGatewayApp.connectServiceConnectConfig.delete.question" interpolate={{ id: connectConfigEntity.id }}>
