  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="connectGatewayApp.connectServiceConnectConfig.home.createOrEditLabel">
            <Translate contentKey="connectGatewayApp.connectServiceConnectConfig.home.createOrEditLabel">
