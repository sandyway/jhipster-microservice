  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="connectGatewayApp.connectServiceRecipient.home.createOrEditLabel">
            <Translate contentKey="connectGatewayApp.connectServiceRecipient.home.createOrEditLabel">Create or edit a Recipient</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : recipientEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="refLabel" for="recipient-ref">
                  <Translate contentKey="connectGatewayApp.connectServiceRecipient.ref">Ref</Translate>
                </Label>
