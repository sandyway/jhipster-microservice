...
export const RecipientDeleteDialog = (props: IRecipientDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="connectGatewayApp.connectServiceRecipient.delete.question">
        <Translate contentKey="connectGatewayApp.connectServiceRecipient.delete.question" interpolate={{ id: recipientEntity.id }}>
