...
import online.kehan.connect.connector.config.Constants;
import online.kehan.connect.connector.config.TestSecurityConfiguration;
import online.kehan.connect.connector.config.audit.AuditEventConverter;
import online.kehan.connect.connector.domain.PersistentAuditEvent;
...
import static online.kehan.connect.connector.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
