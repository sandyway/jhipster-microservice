...
import online.kehan.connect.analytic.collection.service.ConnectEventService;
...
/**
 * REST controller for managing {@link online.kehan.connect.analytic.collection.domain.ConnectEvent}.
 */
@RestController
@RequestMapping("/api")
public class ConnectEventResource {
    ...
    private static final String ENTITY_NAME = "analyticCollectionServiceConnectEvent";
