...
import online.kehan.connect.analytic.collection.service.ReminderService;
...
/**
 * REST controller for managing {@link online.kehan.connect.analytic.collection.domain.Reminder}.
 */
@RestController
@RequestMapping("/api")
public class ReminderResource {
    ...
    private static final String ENTITY_NAME = "analyticCollectionServiceReminder";
