...
/**
 * REST controller for managing {@link online.kehan.connect.analytic.collection.domain.Campaign}.
 */
@RestController
@RequestMapping("/api")
public class CampaignResource {
    ...
    private static final String ENTITY_NAME = "analyticCollectionServiceCampaign";
