...
/**
 * REST controller for managing {@link online.kehan.connect.analytic.collection.domain.State}.
 */
@RestController
@RequestMapping("/api")
public class StateResource {
    ...
    private static final String ENTITY_NAME = "analyticCollectionServiceState";
