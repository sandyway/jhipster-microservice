...
/**
 * REST controller for managing {@link online.kehan.connect.analytic.collection.domain.ConnectState}.
 */
@RestController
@RequestMapping("/api")
public class ConnectStateResource {
    ...
    private static final String ENTITY_NAME = "analyticCollectionServiceConnectState";
