...
/**
 * REST controller for managing {@link online.kehan.connect.analytic.collection.domain.Recipient}.
 */
@RestController
@RequestMapping("/api")
public class RecipientResource {
    ...
    private static final String ENTITY_NAME = "analyticCollectionServiceRecipient";
