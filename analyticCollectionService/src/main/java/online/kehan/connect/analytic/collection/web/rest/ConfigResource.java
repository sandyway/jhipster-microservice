...
/**
 * REST controller for managing {@link online.kehan.connect.analytic.collection.domain.Config}.
 */
@RestController
@RequestMapping("/api")
public class ConfigResource {
    ...
    private static final String ENTITY_NAME = "analyticCollectionServiceConfig";
