...
import online.kehan.connect.flow.service.CampaignFlowService;
import online.kehan.connect.flow.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link online.kehan.connect.flow.domain.CampaignFlow}.
 */
@RestController
@RequestMapping("/api")
public class CampaignFlowResource {
    ...
    private static final String ENTITY_NAME = "flowServiceCampaignFlow";
