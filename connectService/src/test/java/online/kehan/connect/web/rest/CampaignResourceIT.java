...
public class CampaignResourceIT {
    ...
    private static final CampaignType DEFAULT_CAMPAIGN_TYPE = CampaignType.ADHOC;
    private static final CampaignType UPDATED_CAMPAIGN_TYPE = CampaignType.BIRTHDAY;
    ...
    public void getAllCampaigns() throws Exception {
        ...
        restCampaignMockMvc.perform(get("/api/campaigns?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].campaignType").value(hasItem(DEFAULT_CAMPAIGN_TYPE.toString())))
    ...
    public void getCampaign() throws Exception {
        ...
        restCampaignMockMvc.perform(get("/api/campaigns/{id}", campaign.getId()))
            ...
            .andExpect(jsonPath("$.campaignType").value(DEFAULT_CAMPAIGN_TYPE.toString()))
