...
public class ConnectIntentResourceIT {
    ...
    private static final Channel DEFAULT_CONNECT_CHANNEL = Channel.SMS;
    private static final Channel UPDATED_CONNECT_CHANNEL = Channel.MESSENGER;

    private static final String DEFAULT_DESCRIPTION = "AAAAAAAAAA";
    private static final String UPDATED_DESCRIPTION = "BBBBBBBBBB";

    private static final CampaignType DEFAULT_CONNECT_TYPE = CampaignType.ADHOC;
    private static final CampaignType UPDATED_CONNECT_TYPE = CampaignType.BIRTHDAY;
    ...
    public void createConnectIntent() throws Exception {
        ...
        ConnectIntentDTO connectIntentDTO = connectIntentMapper.toDto(connectIntent);
        restConnectIntentMockMvc.perform(post("/api/connect-intents").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(connectIntentDTO)))
    ...
    public void getAllConnectIntents() throws Exception {
        ...
        restConnectIntentMockMvc.perform(get("/api/connect-intents?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].connectChannel").value(hasItem(DEFAULT_CONNECT_CHANNEL.toString())))
            .andExpect(jsonPath("$.[*].description").value(hasItem(DEFAULT_DESCRIPTION)))
            .andExpect(jsonPath("$.[*].connectType").value(hasItem(DEFAULT_CONNECT_TYPE.toString())))
    ...
    public void getConnectIntent() throws Exception {
        ...
        restConnectIntentMockMvc.perform(get("/api/connect-intents/{id}", connectIntent.getId()))
            ...
            .andExpect(jsonPath("$.connectChannel").value(DEFAULT_CONNECT_CHANNEL.toString()))
            .andExpect(jsonPath("$.description").value(DEFAULT_DESCRIPTION))
            .andExpect(jsonPath("$.connectType").value(DEFAULT_CONNECT_TYPE.toString()))
    ...
    public void updateConnectIntent() throws Exception {
        ...
        updatedConnectIntent
            ...
            .updatedDate(UPDATED_UPDATED_DATE)
            .createdBy(UPDATED_CREATED_BY);
        ConnectIntentDTO connectIntentDTO = connectIntentMapper.toDto(updatedConnectIntent);
