...
public class ConnectEventResourceIT {
    ...
    public void createConnectEvent() throws Exception {
        ...
        ConnectEventDTO connectEventDTO = connectEventMapper.toDto(connectEvent);
        restConnectEventMockMvc.perform(post("/api/connect-events").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(connectEventDTO)))
    ...
    public void updateConnectEvent() throws Exception {
        ...
        updatedConnectEvent
            ...
            .reference(UPDATED_REFERENCE)
            .createdDate(UPDATED_CREATED_DATE);
        ConnectEventDTO connectEventDTO = connectEventMapper.toDto(updatedConnectEvent);
