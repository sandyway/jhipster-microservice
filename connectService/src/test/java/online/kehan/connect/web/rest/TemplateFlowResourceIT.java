...
public class TemplateFlowResourceIT {
    ...
    public void createTemplateFlow() throws Exception {
        ...
        TemplateFlowDTO templateFlowDTO = templateFlowMapper.toDto(templateFlow);
        restTemplateFlowMockMvc.perform(post("/api/template-flows").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(templateFlowDTO)))
    ...
    public void updateTemplateFlow() throws Exception {
        ...
        updatedTemplateFlow
            ...
            .createdBy(UPDATED_CREATED_BY)
            .createdDate(UPDATED_CREATED_DATE);
        TemplateFlowDTO templateFlowDTO = templateFlowMapper.toDto(updatedTemplateFlow);
