...
import online.kehan.connect.config.audit.AuditEventConverter;
import online.kehan.connect.domain.PersistentAuditEvent;
...
import static online.kehan.connect.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
